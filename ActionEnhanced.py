    ...
    def parameter(self,comp=None, prog=None):
        ...
        if self.id==0:#INTERCHANGE01
            ...
            if depth==2:
                ...
                loop_extent_1=abs(self.it_dict[first_comp][first_it]['upper_bound']-self.it_dict[first_comp][first_it]['lower_bound'])
                ...
                loop_extent_2=abs(self.it_dict[first_comp][second_it]['upper_bound']-self.it_dict[first_comp][second_it]['lower_bound'])
                ...
                loop_extent_3=abs(self.it_dict[first_comp][third_it]['upper_bound']-self.it_dict[first_comp][third_it]['lower_bound'])
