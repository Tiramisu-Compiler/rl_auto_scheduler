...
class Tiramisu_Program():
    ...
    def check_legality_of_schedule(
        ...
        comps=None,
        first_comp=None
    ):  #Optims_list should be the order of which they should be applied # works only for single comp
        # print("inside check legality of schedule")
...
'''
                ...
                #print("in legality check tiling")
                legality_check_lines += optim.tiramisu_optim_str + '\n'
    ...
    def call_solver(self, comp, params):  #single comp
        ...
        # print("inside call solver with comp", comp)
...
#${GXX} -shared -o ${FUNC_NAME}.o.so ${FUNC_NAME}.o;\
    ...
    def write_wrapper_code(
            self):  #construct the wrapper.cpp and wrapper.h from the program
    ...
    def clean_up_genrated_files(
    ):  # TODO: clean up all the temporary files generated in the function folder
        pass
